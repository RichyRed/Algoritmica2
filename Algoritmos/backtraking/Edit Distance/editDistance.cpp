...
int solveDistance(string a, string b, int positionFirst, int positionSecond) {
    ...
    if(a[positionFirst - 1] == b[positionSecond - 1]) {
        ...
        return 1+ minimumThree(solveDistance(a,b,positionFirst-1, positionSecond), 
                               solveDistance(a,b,positionFirst, positionSecond-1),
                               solveDistance(a,b,positionFirst-1,positionSecond-1)); 
